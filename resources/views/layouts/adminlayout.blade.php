                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto pl-5">
                              <li class="nav-item active text_color">
                                <a class="nav-link text_color" href="{{route('admin.index')}}">Home <span class="sr-only">(current)</span></a>
                              </li>
                               <li class="nav-item">
                                <a class="nav-link  text_color" href="{{route('admin.showpost')}}">All Post</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link  text_color" href="{{route('admin.create')}}">POST NEW CAR</a>
                              </li>
                    </ul>
